...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (theIndex && theIndex.id) {
            ...
            let uuidResponse = await fetch("https://rkfl-bigcommerce.herokuapp.com/payment.php", requestOptions);
    ...
    document.querySelector('.form-checklist.optimizedCheckout-form-checklist').addEventListener('click', (e) => {
